...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val contactsButton = view.findViewById<View>(R.id.buttonContacts)
        val careButton = view.findViewById<View>(R.id.buttonCare)
        val infoButton = view.findViewById<View>(R.id.buttonInfo)
